    ...
    private void convertJSONtoArrayList(JSONObject forecast) {
        ...
        try {
            ...
            for (int i = 0; i < list.length(); i++) {
                ...
                weatherList.add(new Weather(day.getLong("dt"), weather.getString("description"), temperatures.getString("min"), temperatures.getString("max")));
            }
